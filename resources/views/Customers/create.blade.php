                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="formrow-email-input" name="FirstNameCustomer" maxlength="20" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="formrow-password-input" class="form-label">Segundo Nombre</label>
                                    <input type="text" class="form-control" id="formrow-password-input" name="SecondNameCustomer" maxlength="20">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="formrow-email-input" name="LastNameCustomer" maxlength="20" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="formrow-password-input" class="form-label">Segundo Apellido</label>
                                    <input type="text" class="form-control" id="formrow-password-input" name="SecondLastNameCustomer"  maxlength="20">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-4">
                                    ...
                                    <input type="password" class="form-control" id="formrow-password-input" name="password"  maxlength="20" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-6">
                                    <label for="formrow-inputEstatus" class="form-label">Correo Electrónico *</label>
                                    <input type="text" class="form-control" id="formrow-password-input" name="mail"  maxlength="20" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-6">
                                    <label for="formrow-inputEstatus" class="form-label">Direccion de residencia *</label>
                                    <input type="text" class="form-control" id="formrow-password-input" name="Address"  maxlength="20" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-6">
                                    <label for="formrow-inputEstatus" class="form-label">Direccion de entrega *</label>
                                    <input type="text" class="form-control" id="formrow-password-input" name="AddressEntry"  maxlength="20" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-6">
                                    <label for="formrow-inputEstatus" class="form-label">Número celular *</label>
                                    <input type="text" class="form-control" id="formrow-password-input" name="NumberPhone"  maxlength="20" required>
                                </div>
                            </div>
                        </div>
                    </div>
