                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-6">
                                    <input class="form-check-input" name="ManIva" value="1" type="checkbox"  id="gridCheck1" @if($product->ManIva == 1) checked @endif onclick="checkiva({{ $product->PorIva }})">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="number" class="form-control" name="PorIva" id="formrow-PorIva-input" value="{{ $product->PorIva }}" autocomplete="off" required max="100" min="0" placeholder="% iva">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="formrow-PorDesc-input" class="form-label">% Descuento *</label>
                            <input type="number" class="form-control" name="PorDesc" id="formrow-PorDesc-input" autocomplete="off" required max="100" min="0" value="{{ $product->PorDesc }}">
                        </div>
                        <div class="mb-3">
